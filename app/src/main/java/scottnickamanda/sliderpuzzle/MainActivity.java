...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /* An adapter that will hold the possible user sizes in a dropdown box*/
        ArrayAdapter<String> adapter = new ArrayAdapter<> (this,
                    android.R.layout.simple_spinner_item, sizes);
        //Set the dropdown box based off xml defined values
        Spinner gameSize = (Spinner) findViewById(R.id.selectSize);

        //Set the adapter for the dropdown box
        ...
        gameSize.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
             ...
             * The size of the board is set to the index of the selected item + 3
        ...
        launchGame.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //If the user selected a custom board size, add this as an extra in the intent
