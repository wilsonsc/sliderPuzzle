...
public class Piece {
    ...
    /*******************************************************************
     * Constructor that takes one parameter, used in initializing the
     * blank piece
     *
     * @param number the number that should be held as data for the piece
     ******************************************************************/
    public Piece(int number) {
        // Increments +1 for user visualization of starting at piece 1
        // instead of piece 0
    ...
    public Piece(int number, Bitmap image) {
        ...
        // Incremented +1 for user visualization of starting at piece 1
        // instead of piece 0
        this.number = number + 1;
        this.image = image;
    }
